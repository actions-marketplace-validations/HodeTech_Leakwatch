// Package aws, AWS ile ilgili sır dedektörlerini sağlar.
package aws
...
// AccessKeyID, AWS Access Key ID dedektörü.
...
// Scan, verilen veriyi AWS Access Key ID kalıplarına karşı tarar.
